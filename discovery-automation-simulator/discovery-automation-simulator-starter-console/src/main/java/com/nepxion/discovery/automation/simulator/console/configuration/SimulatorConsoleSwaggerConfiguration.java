...
public class SimulatorConsoleSwaggerConfiguration {
    private String discoveryGroup = "Nepxion Discovery Simulator";
    private String discoveryPackages = "com.nepxion.discovery.automation.simulator.console.endpoint";
    ...
    @Bean("simulatorTestDocket")
    public Docket simulatorTestDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(SimulatorConsoleSwaggerConfiguration.basePackage(discoveryPackages)) // 扫描该包下的所有需要在Swagger中展示的API，@ApiIgnore注解标注的除外
